      ...
      <div className="flex flex-col lg:flex-row min-h-[800px]">
        ...
        <div className="w-full lg:w-[55%] p-8 md:p-16 lg:p-24 flex flex-col justify-center">
          ...
          <p className="font-sans font-normal text-[#F4F0EA] opacity-90 text-xs md:text-[15px] leading-[1.5em] mb-3 max-w-2xl">
            ...
            to debut seven entries on the U.S. Billboard Hot 100.
            Renowned for her deep, velvet-toned vocals and radical creative
            autonomy, she released her critically acclaimed debut studio album,
            Born in the Wild, in 2024, followed by the self-produced EP Love Is
            a Kingdom in late 2025. As of 2026, Tems remains a pioneering force
            who bridges the gap between the African continent and the
